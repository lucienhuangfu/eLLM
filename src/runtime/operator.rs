...
mod test {
    ...
    fn test_operator_matmul_topk_f16_avx512_dispatch_small_no_ties() {
        ...
        unsafe {
            let thread_max =
                crate::ops::matmul::matmul_topk::MatMulTopK::<f16>::detect_threads();
    ...
    fn test_operator_experts_matmul_silu_f16_dispatch_single_expert_basic() {
        ...
        unsafe {
            let runner =
                crate::ops::experts::experts_matmul_silu_mul_matmul::ExpertsMatMulSilu::<
                f16,
            >::new(
                a.as_ptr(),
    ...
    fn test_operator_experts_down_f16_dispatch_basic_mb_gt_mr() {
        ...
        unsafe {
            let runner =
                crate::ops::experts::experts_matmul_mul::ExpertsMatMulDown::<f16>::new(
                nonlin.as_ptr(),
                wdown_nt.as_ptr(), // ✅ NT
                experts_indicator.as_ptr(),
                indice.as_ptr(),
    ...
    fn test_operator_merge_add_f16_dispatch_k1_basic() {
        ...
        unsafe {
            let runner =
                crate::ops::experts::experts_merge_add::ExpertsMergeAdd::<f16>::new(
                input.as_ptr(),
                residual.as_ptr(),
                experts_indicator.as_mut_ptr(),
                indice_ptr.as_mut_ptr(),
