...
mod test {
    ...
    fn test_operator_matmul_f16_dispatch_and_parallel_consistency() {
        ...
        op1.run(batch_size, decode_size, 1, 0);
        ...
        for tid in 0..thread_num {
            op2.run(batch_size, decode_size, thread_num, tid);
        }
    ...
    fn test_operator_experts_matmul_silu_f16_dispatch_single_expert_basic() {
        ...
        unsafe {
            let runner = crate::compiler::mul::experts_matmul_silu_mul_matmul::ExpertsMatMulSilu::<
                f16,
            >::new(
                a.as_ptr(),
