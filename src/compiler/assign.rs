...
mod test {
    ...
    fn test_assign_kqv_tile_one_kind_per_thread() {
        assert_eq!(
            ...
            Some(KqvTileAssign { path: KqvPath::V, begin: 0, end: 4 })
        );
        assert_eq!(
            assign_kqv_tile(4, 4, 32, 4, 1),
            Some(KqvTileAssign { path: KqvPath::K, begin: 0, end: 4 })
        );
        assert_eq!(
            assign_kqv_tile(4, 4, 32, 4, 2),
            Some(KqvTileAssign { path: KqvPath::Q, begin: 0, end: 16 })
        );
        assert_eq!(
            assign_kqv_tile(4, 4, 32, 4, 3),
            Some(KqvTileAssign { path: KqvPath::Q, begin: 16, end: 32 })
        );
    }
    ...
    fn test_assign_kqv_tile_skips_empty_segments() {
        ...
        assert_eq!(
            ...
            Some(KqvTileAssign { path: KqvPath::Q, begin: 0, end: 4 })
        );
        assert_eq!(
            assign_kqv_tile(0, 4, 8, 3, 2),
            Some(KqvTileAssign { path: KqvPath::Q, begin: 4, end: 8 })
        );
    }
}
