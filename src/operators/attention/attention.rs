        ...
        + crate::common::num_traits::Exp,
{
    ...
    pub fn run(
        ...
        unsafe {
            ...
            let kv_batch_stride = self.kv_head_num * self.sequence_length * self.head_size;
            ...
            let kv_head_stride = self.sequence_length * self.head_size;
...
mod tests {
    ...
    fn sequence_split_leaves_tail_rows_empty() {
        ...
        assert_close(&output[2 * head_size..3 * head_size], &[-1.0, -1.0]);
    }
}
